...
use Apptha\Marketplace\Model\Order;

abstract class Transactions extends Action {
    /**
     * Core registry
     *
    ...
    protected function _isAllowed() {
        return $this->_authorization->isAllowed ( 'Apptha_Marketplace::manage_transactions' );
    }
}
